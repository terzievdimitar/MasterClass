...
const ProPlanActivatedEmail = ({ name, planType, currentPeriodStart, currentPeriodEnd, url }: ProPlanActivatedEmailProps) => {
					...
					<Section style={content}>
						...
						<Section style={proSection}>
							<Text style={thankYouText}>
								Thank you for upgrading to MasterClass Pro! Your {planType}ly subscription is now active.
							</Text>
